...
if method == 'SVR':
    ...
    best_param["winter"] = [(100, 100, 50), 'relu', 'adam', 0.01, 'constant']#[(100, 50), 'relu', 'adam', 0.001, 'constant']
    best_param["pre_monsoon"] = [(100, 100, 50), 'relu', 'adam', 0.001, 'constant']#[(100, 50), 'relu', 'adam', 0.0001, 'constant']
    best_param["summer"] = [(100, 100, 50), 'relu', 'adam', 0.01, 'constant']#[(50,), 'relu', 'adam', 0.001, 'constant']
    best_param["post_monsoon"] = [(100, 100, 50), 'relu', 'adam', 0.01, 'constant']#[(100, 100, 50), 'relu', 'adam', 0.0001, 'constant']
...
#lib.season_split_plot(df, RH_included)
